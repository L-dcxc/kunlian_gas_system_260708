...
class GasTypesPage(QWidget):
    ...
    def _build_form(self) -> None:
        ...
        fields = (
            ...
            ("默认低报", self.alarm_low_edit), ("默认高报", self.alarm_high_edit),
            ("", self.enabled_check),
        )
    ...
    def _apply_field_widths(self) -> None:
        ...
        for widget in (self.unit_edit, self.range_min_edit, self.range_max_edit, self.alarm_low_edit, self.alarm_high_edit):
